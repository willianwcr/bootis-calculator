import svgPaths from "./svg-pk3szv9l5w";
    ...
    >
      <div className="flex flex-row items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-row items-center justify-between p-[16px] relative w-full">
          ...
          >
            <p className="block leading-[20px]">Acesso restrito</p>
          </div>
          <CloseIcon />
        </div>
      </div>
  ...
  return (
    ...
    >
      <div
        ...
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
        <p className="block leading-[16px] text-nowrap whitespace-pre">Senha</p>
      </div>
      <div
        ...
        <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-[20px] relative w-full">
          ...
          >
            <p className="block leading-[16px]">
              Digite a senha para acessar a área do admin:
            </p>
          </div>
          <InputBox />
        </div>
      ...
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2 h-9 items-center justify-center px-3 py-1.5 relative">
          <div
            ...
            style={{ fontVariationSettings: "'wdth' 100" }}
          >
            <p className="block leading-[16px] whitespace-pre">Acessar</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Desktop2() {
  return (
    <div className="bg-[#f7f7f7] relative size-full" data-name="Desktop - 2">
      <div
