import svgPaths from "./svg-9n8ynom6sw";
...
function RowCell1() {
  return (
    <div
      ...
      data-name="Row / Cell"
    >
      <div className="box-border content-stretch flex flex-row gap-2 h-12 items-center justify-start overflow-clip px-3 py-4 relative w-40">
        <Labels1 />
      </div>
...
function RowCell2() {
  return (
    <div
      ...
      data-name="Row / Cell"
    >
      <div className="box-border content-stretch flex flex-col gap-1.5 h-12 items-start justify-center overflow-clip px-3 py-4 relative w-[250px]">
        <Labels2 />
      </div>
      <div className="absolute border-[#eaeaea] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
    </div>
...
function ComprasTag() {
  return (
    <div className="relative shrink-0 size-3" data-name="Compras / tag">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
...
function InterfaceCancel() {
  return (
    <div className="relative shrink-0 size-3" data-name="Interface / Cancel">
      <svg
        className="block size-full"
        fill="none"
        preserveAspectRatio="none"
